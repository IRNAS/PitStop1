...
## Conclusion
While enclosure made from from polyoxymethylene (POM) passed both tests, we discoved that the enclosure made from polyethylene (PE) was a lot weaker. Tests under only 8 bar showed a large deformation and we have therefore concluded that PE is not suitable for PitStop Tag and Camera enclosures if the design remains unchanged. If the wall thickness of the enclosure would be increases PE could be suitable as well but more tests sould be conducted to confirm that.
